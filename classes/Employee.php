...
public function findBorrowerByName($name) {
        ...
        $query = "SELECT * FROM tbl_borrower WHERE name = '$name'";
	...
	public function findBorrowerByGl($gl_no)
	{
		//get all borrower data by nid
		$sql = "SELECT * FROM tbl_gold_loan WHERE gl_no='$gl_no' ";
		$result = $this->db->select($sql);
		return $result;
	}
